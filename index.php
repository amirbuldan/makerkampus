    ...
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="navbar-header">
        ...
        <a href="#" class="navbar-brand scroll-top">
          <img style="height: 60px; width: 130px; " src="images/icon.png" alt=""></a> </div>
      <!--/.navbar-header-->
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav" style="padding-top: 10px;">
...
<section id="home">
  <div class="banner-container">
        <img src="images/intro.jpg" alt="banner" />
  ...
  <section id="aboutUs" style="padding-top:0;">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 ">
            <p style="font-size:30px; text-align:center;">
              The First Maker Community In Campus
            </p>
        </div>
        <!-- end: -->
      </div>
      ...
      <div class="row">
        <div class="col-md-3" style="text-align:center">
          <div class="">
            <img src="icon/hero.png" alt="hero.png" style="height:150px;width:150px;" />
          </div>
          <h3>From Zero to Hero</h3>
          <p>
            We invite who want to join to learn and innovate already experience or
            new to learn embedded system or robotics
          </p>
        </div>
        <div class="col-md-3" style="text-align:center">
          <div class="">
            <img src="icon/learn.png" alt="learn.png" style="height:150px; width:150px;" />
          </div>
          <h3>Learn With Fun</h3>
          <p>
            Learn with a fun way through events that we provide
          </p>
        </div>
        <div class="col-md-3" style="text-align:center">
          <div class="">
            <img src="icon/networking.png" alt="networking.png" style="height:150px; width:150px;" />
          </div>
          <h3>Highly Scope of Networking</h3>
          <p>
            Connecting member without limit, and strengthen relationships
          </p>
        </div>
        <div class="col-md-3" style="text-align:center">
          <div class="">
            <img src="icon/relation.png" alt="relation.png" style="height:150px; width:150px;" />
          </div>
          <h3>Great Relation Between Member</h3>
          <p>
            Make a good relationship and strengthen solidarity between member
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="heading ">
      ...
      <div class="row">
        <div class="col-md-4">
          <h2>Watch Us</h2>
          <br /><br />
          <p>let's watch this following video</p>
        </div>
        <div class="col-md-8">
          <iframe width="100%" height="315" src="https://www.youtube.com/embed/HFCMGjtj1gA"
  ...
  <div class="container">
    ...
    <div class="row mrgn30">
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
          <div class="">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.662841225672!2d106.7531982142378!3d-6.307950163486597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69efdbb6e5a323%3A0xceb231f0304094b1!2sUIN+Syarif+Hidayatullah+Jakarta!5e0!3m2!1sid!2s!4v1456907745717"
             width="100%" height="300" frameborder="12" style="border:0" allowfullscreen></iframe>
          </div>
        </div>
      </div>
